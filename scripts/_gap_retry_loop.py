#!/usr/bin/env python3
"""Gap retry loop for post-F1 walk (throwaway)."""
...
MAX_ATTEMPTS = int(os.environ.get("MAX_GAP_ATTEMPTS", "20"))
LOG = REPO / f"FCDO_PLANTED_CONFLICT_POST_F1_WALK_{REPORT_ID[:8]}_gap_loop.log"
