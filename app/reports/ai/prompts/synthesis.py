...
REPORT_SYNTHESIS_SYSTEM_PROMPT = (
    ...
    "\n"
    "EVIDENCE RULES:\n"
    "Do not invent fact_key paths — the server binds citations to the knowledge bank.\n"
    "Focus on accurate retrospective prose; only list keys present verbatim in "
    "report_inputs if you cite them (prefix fact: / gap:).\n"
